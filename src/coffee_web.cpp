...
static void appendWeightDiagEventLabels(String& out, uint32_t flags)
{
  ...
  static const EventLabel labels[] = {
    ...
    { T4S3_DIAG_EVENT_BLE_TIMER_START, "BLE_TIMER_START" },
    { T4S3_DIAG_EVENT_BLE_TIMER_STOP, "BLE_TIMER_STOP" },
    { T4S3_DIAG_EVENT_BLE_TIMER_RESET, "BLE_TIMER_RESET" },
    { T4S3_DIAG_EVENT_SHOT_FALSE_START, "SHOT_FALSE_START" },
